jQuery(document).ready(function ($) {
    ...
    /**
     * Select 2 dropdown to fetch products
     */
    var test = $('.selectpicker').select2({
    ...
    /**
     * Add product/product input to bundle type "bundle"
     */
    ...
    // remove additional bundle product input
