...
if (!trait_exists('PBS_Add_To_Cart_Multiple')) :

    trait PBS_Add_To_Cart_Multiple {
         ...
         * @uses bd_add_to_cart
         */
        public static function pbs_add_to_cart_multiple() {

            // empty cart before proceeding
            WC()->cart->empty_cart();
            ...
            if ($bd_products) {
                ...
                $bd_bundle_var_data = ['pbs_bundle_dd' => 'true', 'bundle_id' => $_POST['bundle_id']];
            ...
            // add pbs flag to wc session for later ref (removing other coupons, coupon notifications etc)
            wc()->session->set('is_pbs_bundle', 'yes');
