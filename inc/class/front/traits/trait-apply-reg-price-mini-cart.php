...
if (!trait_exists('PBS_Apply_Regular_Price_Mini_Cart')) :

    trait PBS_Apply_Regular_Price_Mini_Cart {
         ...
         * @return void
         */
        public static function pbs_apply_regular_price_mini_cart($price_html, $cart_item, $cart_item_key) {
